...
public class MainActivityy_driver extends AppCompatActivity implements OnMapReadyCallback {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                switch (id) {
                    ...
                    case R.id.destination:
                        Toast.makeText(MainActivityy_driver.this, "Destination_BusDriver_Activity", Toast.LENGTH_SHORT).show();
                        break;
                    case R.id.bus:
