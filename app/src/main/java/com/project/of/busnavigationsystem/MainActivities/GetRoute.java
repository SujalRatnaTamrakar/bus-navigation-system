...
public class GetRoute extends AppCompatActivity {
    ...
    static String TOPIC;
    static String driverSelectedRoute = MainActivityy_driver.driverSelectedRoute;
...
// Add the red marker icon SymbolLayer to the map
    ...
    public static void getRoute(MapboxMap mapboxMap, Point origin, Point destination, Context context, Activity activity, String callingActivity) {
...
// reset the GeoJSON source for the route LineLayer source
                                        if (source != null) {
                                            ...
                                            if (callingActivity.equals("MainActivityy_driver")) {
                                                getNav(currentRoute, activity, context);
                                            }
...
// reset the GeoJSON source for the route LineLayer source
    ...
    public static void getNav(DirectionsRoute currentRoute, Activity activity, Context context) {
...
// Call this method with Context from within an Activity
    ...
    public static void sendNotifications(String waypoint, int durationToWaypoint) {
