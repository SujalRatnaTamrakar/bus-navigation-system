...
import com.project.of.busnavigationsystem.NavBar.Profile.User;
...
public class SignUpUser extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final MaterialButton signUp = (MaterialButton) findViewById(R.id.button);
        ...
        signUp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (fName.isEmpty()) {
                    ...
                    myFirebaseAuth.fetchSignInMethodsForEmail(Email.getText().toString()).addOnCompleteListener(new OnCompleteListener<SignInMethodQueryResult>() {
                        @Override
                        public void onComplete(@NonNull Task<SignInMethodQueryResult> task) {
                            Log.d("EMAILS", "onComplete: " + task.getResult().getSignInMethods());
